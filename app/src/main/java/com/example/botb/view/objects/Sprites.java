...
public class Sprites {
    ...
    public Bitmap getOpponentNexus(){ return Bitmap.createBitmap(overworldb, 20, 465, 80, 85); }
    ...
    public BitmapDrawable getOpponentBackground(){
        ...
        if (n == 1){sprite = Bitmap.createBitmap(overworldc, 253, 296, 80, 75); }
        else {sprite = Bitmap.createBitmap(overworldc, 0, 296, 80, 81);}
    ...
    public BitmapDrawable getPlayerBackground(){
        ...
        if (n == 1){sprite =  Bitmap.createBitmap(overworldc, 253, 45, 80,75);}
        else {sprite =  Bitmap.createBitmap(overworldc, 0, 10, 80,95 );}
        BitmapDrawable background = new BitmapDrawable(sprite);
        return background;
    }
